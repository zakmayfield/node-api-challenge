...
- [x] Mention two parts of Express that you learned about this week.
  - 1.) Custom Middleware - Middleware that we design ourselves to accomplish things that we specifically need.
  - 2.) Third Party Middleware -- like helmet -- that will add security to our server

- [x] Describe Middleware?
  - an array of functions that get executed in the order they're introduced the next one will execute via next()

- [x] Describe a Resource?
  - anything that can assist with your development

- [x] What can the API return to help clients know if a request was successful?
  - status 200 and whatever data they requested

- [x] How can we partition our application into sub-applications?
  - by using something like 'userRoutes' that handles anything about the API after /api/users
